...
const About = () => {
    ...
    return (
        <section id='services' className='bg-white relative md:pt-[100px] mt-[400px]  lg:mt-[400px] z-[500] px-8'>
            <motion.h2 
            ...
            <div className='flex mt-10 flex-wrap justify-between gap-4 lg:gap-0'>
                <motion.div
                initial={{x: -200, opacity:0}}
                ...
                className='text-center p-8 rounded-[10px] flex-col justify-center border-solid border-2 border-main'>
                    <img src="/police.gif" className='w-[500px]' alt="Police" />
                ...
                animate={isview ? {x:0, opacity:1}: {}}
                className='text-center p-8 rounded-[10px] flex-col justify-center border-solid border-2 border-main'>
                    <img src="/hospital.gif" className='w-[500px]' alt="Police" />
